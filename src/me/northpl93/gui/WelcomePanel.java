...
public class WelcomePanel extends JPanel
{
	...
	public WelcomePanel()
	{
		...
		JLabel lblUycieNiepoprawnychDanych = new JLabel(
				"U\u017Cycie niepoprawnych danych spowoduje, \u017Ce nie b\u0119dziesz m\u00F3g\u0142 pisa\u0107!");
		lblUycieNiepoprawnychDanych
		...
		chckbxRollOnNewPost = new JCheckBox(
				"Przewijaj gdy pojawi si\u0119 nowy post");
		...
		chckbxCzyZapamietacSesje = new JCheckBox(
				"Zapami\u0119ta\u0107 sesj\u0119?");
	...
	public void loginStuff() // Wywoływane przy logowaniu
	{
		...
		Main.getConfig()
				.setSessionStored(chckbxCzyZapamietacSesje.isSelected());

		if (textField.getText() == null || textField_1.getText() == null
				|| textField.getText().equalsIgnoreCase("")
				|| textField_1.getText().equalsIgnoreCase(""))
		{
			JOptionPane
					.showMessageDialog(
							null,
							"Któreś z podanych pól pozostawiłeś puste! Nie będziesz mógł pisać wiadomości :C");
		...
		((ChatListenThread) Main.chatListener).setLoggedUser(XenForoUtils
				.loginUser(textField.getText(), textField_1.getText()));
